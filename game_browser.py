...
title_font = pygame.font.Font("fonts/m6x11.ttf", 48)
...
# Options
keep_width_mode = (
    True  # Set to False for "Fit to screen" mode, True for "Keep width, clip height"
)
...
while running:
    ...
    if games:
        ...
        render_wrapped_text(
            screen, f"Model: {game.get('model', 'Unknown')}", (50, 170), metadata_font
        )
        render_wrapped_text(
            screen,
